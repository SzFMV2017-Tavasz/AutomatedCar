...
public class InWayTest {
    ...
    public void setup(){
        ...
        car = new AutomatedCar(480, 800, 108, 240, 0d, 0, "car_1_white.png", 200d, 0d, 0d, 0,0);
    }
    @Test
    public void IsInRect(){
        List<IWorldObject> obj=new ArrayList<>();
        IWorldObject in=new Bycicle(0.5, 0.5, 0.8, 0.8, 0, 0, "imageFilePath", 0, 0, 0, 0,0);
        obj.add(in);
    ...
    public void IsNotInRect(){
        List<IWorldObject> obj=new ArrayList<>();
        IWorldObject in=new Bycicle(1.5, 1.5, 0.8, 0.8, 0, 0, "imageFilePath", 0, 0, 0, 0,0);
        obj.add(in);
    ...
    public void CarFrontTestTrue(){
        List<IWorldObject> obj=new ArrayList<>();
        IWorldObject in=new Bycicle(500, 700, 0.8, 0.8, 0, 0, "imageFilePath", 0, 0, 0, 0,0);
        obj.add(in);
    ...
    public void CarFrontTestFalse(){
        List<IWorldObject> obj=new ArrayList<>();
        IWorldObject in=new Bycicle(500, 900, 0.8, 0.8, 0, 0, "imageFilePath", 0, 0, 0, 0,0);
        obj.add(in);
    ...
    public void CarBackTestTrue(){
        List<IWorldObject> obj=new ArrayList<>();
        IWorldObject in=new Bycicle(500, 1000, 0.8, 0.8, 0, 0, "imageFilePath", 0, 0, 0, 0,0);
        obj.add(in);
    ...
    public void CarBackTestFalse(){
        List<IWorldObject> obj=new ArrayList<>();
        IWorldObject in=new Bycicle(600, 800, 0.8, 0.8, 0, 0, "imageFilePath", 0, 0, 0, 0,0);
        obj.add(in);
